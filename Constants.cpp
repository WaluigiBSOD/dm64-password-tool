...
extern const string ProgramVersion =                                        "1.0 Alpha";

extern const unsigned int AutotestIterations =                              1 << 3; // 1 << 31 for very very very very very extensive testing.
...
extern const unsigned char GameLevelMedium =                                1;
...
extern const unsigned int ReturnAutotestFail =                              19;
...
extern const unsigned int DataTypeSignedCharWrongSize =                     20;
extern const unsigned int DataTypeUnsignedCharWrongSize =                   21;
extern const unsigned int DataTypeSignedShortWrongSize =                    22;
extern const unsigned int DataTypeUnsignedShortWrongSize =                  23;
extern const unsigned int DataTypeSignedIntWrongSize =                      24;
extern const unsigned int DataTypeUnsignedIntWrongSize =                    25;
extern const unsigned int DataTypeSignedLongLongWrongSize =                 26;
extern const unsigned int DataTypeUnsignedLongLongWrongSize =               27;
...
extern const char SpecialASCII[] = {SpecialCharacterTilde,SpecialCharacterSlashSmall,SpecialCharacterCenteredDot,SpecialCharacterDot,SpecialCharacterQuestionMark,SpecialCharacterHeart,SpecialCharacterStar,SpecialCharacterCircle,SpecialCharacterMarkX,SpecialCharacterSlashBig,SpecialCharacterColon,SpecialCharacterPercentual,SpecialCharacterAccent,SpecialCharacterAmperstand,SpecialCharacterDotAlternative};
...
extern const unsigned char ConversionAsciiToInternal =                      ' ';
...
extern const unsigned char GameLevel[3] =                                   {GameLevelEasy,GameLevelMedium,GameLevelHard};
